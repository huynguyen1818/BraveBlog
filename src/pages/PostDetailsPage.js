...
const PostDetailsPage = () => {
  ...
  console.log("file: PostDetailsPage.js ~ line 105 ~ postInfo", postInfo);
  useEffect(() => {
  ...
  const date = postInfo?.createdAt?.createdAt?.seconds
    ? new Date(postInfo?.createdAt?.createdAt?.seconds * 1000)
    : new Date();
